...
describe("createForUser", () => {
  it("should create a message for a specific user", async () => {
    await user.upsert(USER_ID_1);

    await message.createForUser(MESSAGE_CONTENT, USER_ID_1);
  ...
  it("should use custom options when provided", async () => {
    ...
    await message.createForUser(MESSAGE_CONTENT, USER_ID_1, { priority: 500, maxAttempts: 3 });
